...
// extract the user id from the token cookie, and return User type
func who(r *http.Request) User {
	// ignore error, supposed to be used after auth
	cookie, _ := r.Cookie("token")
	useridStr := strings.Split(cookie.Value, "-")[0]
